    ...
    <form method="POST" action="{{ route('payment.process') }}" class="mt-5" onsubmit="return prepararCamposHidden(event)">
        ...
        <div class="text-center my-4">
            ...
            <div class="row justify-content-center g-4">
                ...
                <!-- Por hora, retirei o método de pagamento com multibanco , estou com erros de conexão -->
...
<script>
    ...
    // Ao carregar a página, atualiza o estado dos botões e recalcula o total
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('payment_method').value = '{{ old('
        payment_method ') }}';
        document.getElementById('finalizar-btn').disabled = false;
        document.getElementById('finalizar-btn').style.opacity = 1;
        @endif
