...
.days-meal-image {
    width: 100%;
    height: 100%; /* Atualizado para ocupar 100% da altura do elemento pai */
    min-height: 400px; /* Altura mínima para manter consistência */
    background-repeat: no-repeat;
    background-size: contain; /* Ajusta para caber completamente na vertical */
...
.meal-details {
    margin-bottom: 8px; /* Aproxima a div dos elementos subsequentes */
}

form.mt-0 {
    margin-top: 0; /* Remove a margem padrão superior do formulário */
}

.col-lg-7 {
    justify-content: flex-start; /* Garante que os elementos fiquem alinhados em cima e próximos */
}


.col-lg-5, .col-lg-7 {
    padding: 0.5rem; /* Aproxima ainda mais */
}
</style>
